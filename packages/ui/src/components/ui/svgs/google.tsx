...
const Google = (props: SVGProps<SVGSVGElement>) => {
  const idPrefix = `notra-google-${useId().replaceAll(":", "")}-`;
  ...
  >
    ...
    <defs>
      ...
      <clipPath clipPathUnits="userSpaceOnUse" id={`${idPrefix}i`}>
    ...
    <g clipPath={`url(#${idPrefix}i)`} transform="matrix(.95792 0 0 .98525 -90.174 -78.856)">
      <path
