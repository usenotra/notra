...
CREATE INDEX "geoMentionChecks_project_captured_cover_idx" ON "geo_mention_checks" USING btree ("project_id","captured_at","organization_id","language","engine","prompt_id","mentioned","position","sentiment");--> statement-breakpoint
