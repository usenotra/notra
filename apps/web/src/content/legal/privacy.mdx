...
This Privacy Policy describes how Notra, Inc. ("Notra", "we", "us", or "our") collects, uses, and protects your personal information when you use our website at usenotra.com and our dashboard application at app.usenotra.com (collectively, the "Service"). Notra, Inc. is the controller of your personal data where applicable data protection law uses that term. By using the Service, you agree to the collection and use of information in accordance with this policy.
...
**Contact Data:** When you use our contact form, we collect your name, email address, company (if provided), and message to handle your inquiry. To screen for spam, we send only the message text to TypeSafe AI's Jev model through Vercel AI Gateway; the separate name, email, and company fields are not sent to the model. Your message may contain personal information you choose to include. Messages classified as spam are not forwarded to our team.
...
- **Vercel** — Hosting, deployment, and AI Gateway access for content generation and contact-form spam classification
- **TypeSafe AI** — Jev model used through Vercel AI Gateway to classify contact-form messages for spam
...
Contact messages forwarded to our team are retained as needed to handle the inquiry. We do not save messages classified as spam.
...
- **Contact inquiries and spam prevention:** To handle contact-form submissions and classify message text for spam before forwarding inquiries
