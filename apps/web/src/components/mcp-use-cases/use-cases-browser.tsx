...
const PILL_BASE =
  "flex shrink-0 cursor-pointer items-center gap-1.5 rounded-full px-4 py-1.75 font-medium font-sans text-[0.875rem] leading-[1.29] tracking-[-0.01em] outline-none transition-[color,background-color,box-shadow] duration-100 ease-out focus-visible:ring-2 focus-visible:ring-primary";
const PILL_ACTIVE =
...
export function McpUseCasesBrowser({
  ...
  return (
    <div className="flex w-full flex-col items-center">
      ...
      <section className="flex w-[min(100%-3rem,80rem)] flex-col gap-6 pt-10">
        <div
