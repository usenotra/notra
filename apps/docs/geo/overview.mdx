...
followed by compact **AI model families** rows. Each row shows the family's logo,
name, a score bar and its score. Families follow the standard GEO brand order,
...
An unrated family shows a dash with no bar; an all-negative family scores 0.
